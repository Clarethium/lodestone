...
This is a working reference. Where the document specifies, the wording is intentional. Where it leaves room for adaptation to specific contexts, tools, or projects, it does so explicitly.
