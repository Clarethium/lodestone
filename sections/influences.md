...
**Distributed and extended cognition (Edwin Hutchins; Andy Clark).** Hutchins's *Cognition in the Wild* (1995) frames cognition as a property of human-tool-environment systems. Clark's extended-mind thesis (with David Chalmers, "The Extended Mind," 1998; *Supersizing the Mind*, 2008) treats cognitive processes as legitimately spanning brain, tool, and environment. Section I's framing of operator-AI work as a coupled cognitive system draws on this tradition; the framing is foundational rather than tied to one mechanism.

Engagement with each tradition is provisional and will deepen in subsequent versions. This page lists the points of contact; the works themselves carry far more apparatus than is operationalized here.
