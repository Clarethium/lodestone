...
Calibration (Section III) and Altitude are two key meta-skills. Calibration asks what stance fits the conditions. Altitude asks what level of reasoning fits the question. The two operate together: an operator can be wrongly calibrated at the right altitude, or rightly calibrated at the wrong altitude. Both fail. Both need to hold for the methodology to function.
